...
**In Row 49 it split the name at the first dash so that Ki went in the first name_1 column and Adi went in the name_2 column.  "-Mundi" was omitted and is missing.**
...
**I had to use length(month) instead of count(month) because it could not count months when they were characters.**
